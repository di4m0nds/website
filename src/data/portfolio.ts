...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: 'DOSEP MOVIL',
    description:
      'Government health service app with 50,000+ downloads on Google Play. Enables users to request medical orders, generate pharmacy tokens, and pay for healthcare services. Built with Flutter/Dart + Firebase backend.',
  ...
  },
  {
    ...
    name: 'SIGEM S.L.',
    description:
      'Government services app for San Luis city, streamlining access to public procedures. Features appointment booking for driver licenses, municipal permits, and real-time bus tracking. Legacy code recovery from undocumented codebase.',
  ...
  },
  {
    ...
    name: 'CHEFCO PASTAS',
    description:
      'Online ordering platform for artisanal pasta dishes. Full e-commerce experience with menu browsing, cart, and order management. Fully responsive design with optimized performance and SEO.',
  ...
  },
  {
    ...
    description:
      'Photography portfolio showcasing visual storytelling with optimized gallery. Features lightbox viewer, lazy loading for performance, and full mobile responsiveness. Lighthouse score 98/100.',
    tags: ['React', 'Tailwind', 'Lightbox', 'Lazy Loading', 'Gallery Optimization', 'Image Optimization'],
  ...
  },
  {
    ...
    description:
      'Immersive journey through rocket history and technology. Features seamless transitions using View Transitions API for a smooth, modern experience across desktop and mobile browsers.',
    tags: ['Astro', 'Tailwind', 'View Transitions API', 'Intersection Observer', 'Animations', 'Responsive Design'],
  ...
  },
  {
    ...
    name: 'TESLA CLONE',
    description:
      'Tesla website clone built with Astro and Tailwind CSS. Showcases product lineup with snap scrolling, responsive design, and modern web techniques. Responsive navbar with smooth scroll behavior and animations.',
    tags: ['Astro', 'Tailwind', 'Intersection Observer', 'Snap Scrolling', 'Responsive Design', 'Performance'],
