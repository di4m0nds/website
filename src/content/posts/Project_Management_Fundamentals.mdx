...
tags: ["control", "scope", "goals", "time", "fundamentals"]
---
<p class="w-full my-3 flex flex-row gap-x-2 justify-end">**Publication date:** Under Construction</p>
...
<div id="tablecontent">
# Table of Contents
- **1.** [What is a Project?](/posts/project_management_fundamentals#what-is-a-project)
- **2.** [Project, Programs, and Portfolio](/posts/project_management_fundamentals#projects-programs-and-portfolio)
- **3.** [Management and Lifecycle](/posts/project_management_fundamentals#management-and-lifecycle)
- **4.** [Times in a Project](/posts/project_management_fundamentals#times-in-a-project)
- **5.** [Resources and Costs](/posts/project_management_fundamentals#resources-and-costs)
- **6.** [Risks and Crises](/posts/project_management_fundamentals#risks-and-crises )
- **7.** [...](/posts/project_management_fundamentals#)
</div>
...
As Project Management u must know that someting could be wrong in any moment in the project, and that is normal. We need to analyze what are those potential risks during the execution.
